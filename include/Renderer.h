...
public:
	...
	//draw shape method
	void DrawShape(glm::vec2 position, glm::vec2 size = glm::vec2(10.0f), float rotate = 0.0f, glm::vec4 color = glm::vec4(1.0f));
	void DrawLine(glm::vec2 position, float size = 10.0f, float rotate = 0.0f, glm::vec4 color = glm::vec4(1.0f));
